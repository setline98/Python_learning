...
plt.plot(data1['Month'], data1['Average Value'], color='red', label='Re:Zero')
plt.plot(data2['Month'], data2['Average Value'], color='green', label='Dr.Stone')
plt.plot(data3['Month'], data3['Average Value'], color='blue', label='Mushoku Tensei')
